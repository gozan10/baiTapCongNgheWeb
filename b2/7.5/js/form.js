...
function Chapnhan() {
	...
	if (document.getElementById("pass").value == "") {
		document.getElementById("loi_pass").innerHTML = "Mật khẩu chưa nhập kìa :)";
		document.getElementById("pass").focus();
		okie = false;
	} else if (document.getElementById("repass").value == "") {
		document.getElementById("loi_repass").innerHTML = "Nhập lại pass đê -.-";
		document.getElementById("repass").focus();
		okie = false;
	} else if (document.getElementById("pass").value  != document.getElementById("repass").value ) {
		document.getElementById("loi_pass").innerHTML = "Nhập lại mật khẩu lần nữa mà cũng không trùng :)";
		document.getElementById("pass").focus();
		okie = false;
	}
